...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, RGB_DS4_Pin|RGB_DS2_Pin|NUCLEO_LD2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : RGB_DS4_Pin RGB_DS2_Pin NUCLEO_LD2_Pin */
  ...
  /*Configure GPIO pin : NUCLEO_LD1_Pin */
